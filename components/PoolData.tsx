...
export default async function PoolData() {
    return (
        <>
            ...
            <div className="flex">
                <div className="w-full mt-5 min-h-[600px] dark:bg-gray-900 border bg-white border-gray-800 rounded-xl ">
                    <div className="mx-auto max-w-7xl p-5 ">
                        <p className="text-xl dark:text-white text-gray-800">Entries</p>
